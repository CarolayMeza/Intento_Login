						...
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									<input type="number" name="precio1" value="<%=precioP%>" id="precio1" > 
									<input type="number" value="<%=ivaP%>" id="iva1" hidden>
									<input type="number" name="totalIva1" id="totalIva1" placeholder="totalIva1" value="0" >
									<input type="number" name="ValorVP1" id="ValorVP1" placeholder="ValorVP1" value="0" >
						...
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									name="codiP" value="<%=codP2%>"> 
									
									<input type="number" name="precio2" value="<%=precioP2%>" id="precio2" > 
									<input type="number" value="<%=ivaP2%>" id="iva2" hidden > 
									<input type="number" name="totalIva2" id="totalIva2" placeholder="totalIva2" value="0" >
									<input type="number" name="ValorVP2" id="ValorVP2" placeholder="ValorVP2" value="0" >
							</div>
						</div>
						<div class="col-lg">
							<div class="input-group my-3">
								<input type="text" class="form-control"
									...
									name="codiP" value="<%=codP3%>"> 
									
									<input type="number" name="precio3" value="<%=precioP3%>" id="precio3" > 
									<input type="number" value="<%=ivaP3%>" id="iva3" hidden> 
									<input type="number" name="totalIva3" id="totalIva3" placeholder="totalIva3" value="0" >
									<input type="number" name="ValorVP3" id="ValorVP3" placeholder="ValorVP3" value="0" >
							</div>
						</div>
			...
			<form action="Controlador_ventas" method="post">
				...
				<div class="col-lg-4">
					<div class="input-group my-3">
						<p>Total venta</p>
						<input type="text" class="form-control" placeholder="$ 0.000"
							name="totalV" name="totalV" id="totalV" value="0">
					</div>
				</div>
				<div class="col-lg-4">
					<div class="input-group my-3">
						<p>total IVA</p>
						<input type="text" class="form-control" placeholder="$ 0.000"
							name="totalIva" name="totalIva" id="totalIva" value="0">
					</div>
				</div>
				<div class="col-lg-4">
					<div class="input-group my-3">
						<p>total con IVA</p>
						<input type="text" class="form-control" placeholder="$ 0.000"
							name="totalT" name="totalConIva" id="totalConIva" value="0">
					</div>
